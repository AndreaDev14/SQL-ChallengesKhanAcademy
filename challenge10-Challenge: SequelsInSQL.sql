...
with a sequel_id column that matches the id of the sequel for each movie.
*/
...
SELECT movies.title AS Title, sequel.title AS Sequel
FROM movies LEFT OUTER JOIN movies sequel 
